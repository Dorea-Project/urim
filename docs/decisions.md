...
| L'accueil lit le vrai fil du serveur, mais le **fil guidé** derrière la carte reste la maquette : il n'est pas encore bâti sur `TurnView`. Ouvrir une carte ne montre donc pas ce que le moteur vient de dire | Prochaine étape |
