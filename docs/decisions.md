...
| La suppression du compte est **locale** : aucun contrat serveur n'expose de résiliation, donc le numéro reste connu du service après effacement (D47) | Quand le serveur ouvrira une route de résiliation |
